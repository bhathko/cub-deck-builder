...
function X(e, n, s, i, r, o) {
  ...
  for (let t = 0; t < n.length; t++)
    e.push({ value: n[t], at: I(r, o, i[t]), easing: q(s, t) });
}
function G(t, e) {
  return t.at === e.at
    ? null === t.value
...
const ft = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  ...
  vt = ft(yt),
  wt = (t) =>
    (t *= 2) < 1 ? 0.5 * yt(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
...
const he = {
  ...
  pe = {
    ...
    parse: (t) =>
      ce.test(t) ? ce.parse(t) : de.test(t) ? de.parse(t) : he.parse(t),
    transform: (t) =>
      "string" == typeof t
        ? t
...
const xe = {
    test: function (t) {
      ...
      return (
        isNaN(t) &&
        "string" == typeof t &&
        ((null === (e = t.match(re)) || void 0 === e ? void 0 : e.length) ||
          0) +
          ((null === (n = t.match(fe)) || void 0 === n ? void 0 : n.length) ||
            0) >
          0
      );
    },
...
class De {
  ...
  get resolved() {
    return (
      this._resolved || this.hasAttemptedResolve || (ne(), ee()),
      this._resolved
    );
  }
...
function rn(t, e) {
  const n = { ...t, ...e },
    s = {};
  for (const i in n)
    void 0 !== t[i] && void 0 !== e[i] && (s[i] = nn(t[i])(t[i], e[i]));
  return (t) => {
  ...
  const i = Y(s) ? s.map(Ue) : Ue(s),
    ...
    a = ln(o, e, {
      ease: Array.isArray(i)
        ? i
        : ((l = e), (u = i), l.map(() => u || je).splice(0, l.length - 1)),
    });
  var l, u;
  return {
...
class Mn extends De {
  ...
  initPlayback(t, e) {
    ...
    const h = xn(a.owner.current, l, t, {
      ...this.options,
      duration: s,
      times: i,
      ease: r,
...
function Dn(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const e in u) {
    ...
    (Ln(t, e),
      s.start(
        Pn(e, s, i, t.shouldReduceMotion && it.has(e) ? { type: !1 } : l, t, d),
      ));
    const p = s.animation;
    p && c.push(p);
  }
  ...
  renderInstance(t, e, n, s) {
    !(function (t, e, n, s) {
      ...
      for (const n in e.attrs)
        t.setAttribute(ls.has(n) ? n : Rn(n), e.attrs[n]);
    })(t, e, 0, s);
  }
  mount(t) {
    var e;
...
class As {
  constructor(t, e, n, s) {
    ...
    const o = () => {
      (this.setValue(t, e, ht(n, this.options)),
        this.cancel(),
        this.resolveFinishedPromise());
    };
    Vn()
  ...
  attachTimeline(t) {
    return (
      this.animation ? Sn(this.animation, t) : (this.pendingTimeline = t),
      i
    );
  }
}
  ...
  return (
    n.forEach((t) => {
      ...
      (n || ((n = new Set()), ks.set(t, n)),
        n.add(e),
        null == Fs || Fs.observe(t));
    }),
    () => {
      n.forEach((t) => {
        const n = ks.get(t);
        (null == n || n.delete(e),
          (null == n ? void 0 : n.size) || null == Fs || Fs.unobserve(t));
      });
    }
  );
}
...
function Hs(t, e, n) {
  ...
  (c &&
    ((e[r].interpolate = ln(e[r].offset, D(s))),
