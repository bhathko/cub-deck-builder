...
v2.0-20260725…)」,並含「可用模板包:light@2026-07-26.1」。
...
預期:回答 `v2.0-20260725` 與 `light@2026-07-26.1`。**版本不對就是 Step 1/2
沒生效**,回頭重做。
...
- [ ] 8 條全過 → 通知團隊可以用了,附上版本代號 `v2.0-20260725`
