// Merge slide PNGs into a PowerPoint deck.
// Converted from the upstream bun/TypeScript version to plain Node.js (ESM):
//   - stripped TypeScript types
//   - replaced bun-only `import.meta.dir` with `fileURLToPath(import.meta.url)`
// Run with: node merge-to-pptx.mjs <slide-deck-dir> [--output filename.pptx]
// Deps (pptxgenjs) are declared in scripts/package.json — run `npm install` once.
